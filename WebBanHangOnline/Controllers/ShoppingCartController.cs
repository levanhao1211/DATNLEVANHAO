        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    WebBanHangOnline.Common.Common.SendMail("LVHShop", "Đơn hàng #" + order.Code, contentCustomer.ToString(), req.Email);
                    ...
                    WebBanHangOnline.Common.Common.SendMail("LVHShop", "Đơn hàng mới #" + order.Code, contentAdmin.ToString(), ConfigurationManager.AppSettings["EmailAdmin"]);
                    cart.ClearCart();
